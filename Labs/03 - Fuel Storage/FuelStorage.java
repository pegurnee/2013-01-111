...
public class FuelStorage
{
    public static void main(String [ ] args)
    {
        ...
        double volume, radius, height; // variables to compute volume, used in stage 3
        int checkValid = 0; // checks if the inputted numbers were valid
        
        Scanner keyboard = new Scanner(System.in);
        
        // Stage 1:
        /*System.out.print("Enter upper limit for: ");
        ...
        */
        ...
        {
            System.out.println("Now enter some stats about the number " + (count + 1) + " tank:");
            System.out.println();
            ...
            if (height <= 0)
            {
                ...
                while (checkValid < 1) 
                {
                    System.out.print("[Check " + (countCheck + 1) + "] Input real Height (in feet): ");
                    height = keyboard.nextDouble();
                    keyboard.nextLine();
             ...
             if (radius <= 0)
            {
                ...
                while (checkValid < 1) 
                {
                    System.out.print("[Check " + (countCheck + 1) + "] Input real Radius (in feet): ");
                    radius = keyboard.nextDouble();
                    keyboard.nextLine();
        ...
        yrdsCubed = sum / 27;
        System.out.println("The total storage available for fuel is approximately " + yrdsCubed + " cubic yards.");
