...
//                 if (C.userYesOrNo(user.getName() + ", would you like to add more room to " +
//                     "the cart?", "Get a Bigger Cart"))
//                 {
//                     user.enlargeCart(C.userInputInt(user.getName() + ", by how much would you " +
//                         "like to enlarge your cart?", "Get a Bigger Cart"));
//                     C.showMessage("Cart enlarged.", "Cart Enlarged");
//                 }
