package com.egurnee.school.intro.labs.l04;
...
public class ForLoop {
	public static void main(String[] args) {
		...
		System.out.print("What stage of Lab 4 do you want to see? "); // prompt
																		// to
																		// view
																		// stage
																		// of
		...
		if (whatStage == 1) {
			...
			for (int count = 0; count <= 10; count++) {
				System.out.println((count - 5)); // displays each number in the
													// count, less 5
			}
		}
			...
			for (int count = 1; count <= 12; count++) {
				System.out.println((count * 2)); // displays each number in the
			...
			// part 4, displays each character in an inputted string, in reverse
			// order
			String userString;
			...
			System.out.println("That's not a valid stage."); // in case user
																// inputs wrong
																// stage
		}
	}
